<!--
 * @Author: your name
 * @Date: 2020-11-28 12:21:52
 * @LastEditTime: 2020-12-15 14:00:29
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /oms.fandow.com/components/watermark1.vue
-->
<template>
  <div></div>
</template>
...
export default {
  ...
  methods: {
    init() {
      let elementById = document.getElementById('_waterMark')
