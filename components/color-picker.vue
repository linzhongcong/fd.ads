 ...
 * @LastEditTime: 2021-04-22 11:33:21
...
<template>
  ...
  >
    ...
    <div
      class="colorBtn"
      :style="{ backgroundColor: showColor, cursor: disabled ? 'no-drop;' : 'pointer' }"
    ...
    <div class="box" :class="{ open: openStatus }">
      <div class="hd">
        <div class="colorView" :style="`background-color: ${showPanelColor}`" />
        <div
          class="defaultColor"
...
<script>
  ...
  export default {
    ...
    methods: {
      openPanel() {
        if (this.disabled) return (this.openStatus = false)
