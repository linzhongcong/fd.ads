<!--
 * @Author: your name
 * @Date: 2021-09-17 13:43:09
 * @LastEditTime: 2021-09-22 15:25:46
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \ads.fandow.com\pages\property\promotion-data\import-data.vue
-->
<template>
  <div>
  ...
  export default {
    ...
    methods: {
      ...
      handleRemove(file) {
        ...
        this.form.file.splice(this.form.file.indexOf(file), 1)
      },
