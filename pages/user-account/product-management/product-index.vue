...
<template>
  <div class="product-wrap">
    <div class="filter">
      <div class="left">
        ...
        >
          ...
          <a-form-model-item label="商品名称" style="margin-left:10px">
            <a-input
              allow-clear
    ...
    <div class="content">
      ...
      >
        <template slot="operate" slot-scope="text, record, index">
          ...
          <a-button type="link" @click="deletePromotionItem(record)">删除</a-button>
        </template>
        <template slot="adId" slot-scope="text, record, index">
    ...
    <!-- 新建或编辑 -->
    <ProductDetail ref="productDetial" @confirm="getInitData" />
